...
if (!isset($_COOKIE['user_id'])) {
    if (isset($_POST['loginSubmit'])) {
        ...
        if (mysqli_num_rows($result) == 1) {
            ...
            setcookie('user_id', $row['id'], 0, ROOTDIR, $domain, false);
            setcookie("user_name", $username, 0, ROOTDIR, $domain, false);
        } else {
            echo "400";
        }
        exit;
                                    ...
                                    <div class="swiper-slide swiper-no-swiping">
                                        <div class="panel-body">
                                            ...
                                            <form class="layui-form" action="" id="loginForm">
                                                ...
                                                <button type="button" class="layui-btn layui-btn-normal layui-btn-disabled dp-block" lay-submit lay-filter="loginSubmit" id="loginSubmit" name="loginSubmit" disabled="disabled">登 录</button>
                                            </form>
                                        </div>
                                        <div class="pad-all">
                                    ...
                                    <div class="swiper-slide swiper-no-swiping">
                                        <div class="panel-body">
                                            ...
                                            <form class="layui-form" action="" id="regForm">
                                                ...
                                                <button type="button" class="layui-btn layui-btn-normal dp-block" lay-submit lay-filter="regSubmit" id="regSubmit" name ="regSubmit" >注 册</button>
